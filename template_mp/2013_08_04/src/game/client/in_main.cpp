...
static  kbutton_t   in_changeteam;
static  kbutton_t   in_changeclass;
#endif
...
#if defined ( SDK_DLL ) && defined ( SDK_DEV_DLL ) && defined ( SDK_DEV_CLIENT_DLL )
void IN_ChangeTeamDown( const CCommand &args ) {KeyDown(&in_changeteam, args[1] );}
void IN_ChangeTeamUp( const CCommand &args ) {KeyUp(&in_changeteam, args[1] );}
void IN_ChangeClassDown( const CCommand &args ) {KeyDown(&in_changeclass, args[1] );}
void IN_ChangeClassUp( const CCommand &args ) {KeyUp(&in_changeclass, args[1] );}
#endif
...
#if defined ( SDK_DLL ) && defined ( SDK_DEV_DLL ) && defined ( SDK_DEV_CLIENT_DLL )
static ConCommand startchangeteam("+changeteam", IN_ChangeTeamDown);
static ConCommand endchangeteam("-changeteam", IN_ChangeTeamUp);
static ConCommand startchangeclass("+changeclass", IN_ChangeClassDown);
static ConCommand endchangeclass("-changeclass", IN_ChangeClassUp);
#endif
