...
#if 0
#if defined ( SDK_DLL ) && defined ( SDK_DEV_DLL )
#include "sdk_newoptionsmenu_interface.h"
#include "isdk_newoptions.h"
#endif
#endif // 0
...
#if 0
#if defined ( SDK_DLL ) && defined ( SDK_DEV_DLL )
	VPANEL gameParentDLL = enginevgui->GetPanel( PANEL_GAMEUIDLL );
	g_pSDKNewOptions->Create(gameParentDLL);
#endif
#endif
}
