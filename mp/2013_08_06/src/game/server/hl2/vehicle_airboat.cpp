...
ConVar sk_airboat_gun_enabled( "sk_airboat_gun_enabled", "0", FCVAR_CHEAT, "Airboat vehicle spawns with a gun. 0 = false, 1 = true." );
#endif
...
{
#ifdef HL2MP_DEV_DLL
	m_bHasGun = sk_airboat_gun_enabled.GetBool();
#endif
...
#ifdef HL2MP_DEV_DLL
	trace_t tr;
	UTIL_TraceLine( vecGunPosition, vecGunPosition + ( vecRay * MAX_TRACE_LENGTH ), MASK_SOLID, this, COLLISION_GROUP_NONE, &tr );
	UTIL_Tracer( tr.startpos, tr.endpos, 0, TRACER_DONT_USE_ATTACHMENT, 600, false, GetTracerType() );
#endif
