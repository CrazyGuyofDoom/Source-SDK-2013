...
#if defined ( SWARM_DOF_ENABLED )

	CEnvDOFController *pDOFController = static_cast<CEnvDOFController*>( CreateEntityByName( "env_dof_controller" ) );
	if ( pDOFController )
	{
		pDOFController->Spawn();
		pDOFController->Activate();

		variant_t variant;
		variant.SetFloat( 2.0f );
		pDOFController->AcceptInput( "InputSetNearBlurRadius", this, this, variant, 0 );
		variant.SetFloat( 8.0f );
		pDOFController->AcceptInput( "InputSetFarBlurRadius", this, this, variant, 0 );
	}
